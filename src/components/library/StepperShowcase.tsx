...
<p className="text-sm text-muted-foreground text-center mt-2">
  Etapa {currentStep} de {totalSteps}
      ...
      <ComponentCard
        ...
        category="Progresso"
        code={`import { User, MapPin, CreditCard, CheckCircle } from "lucide-react";
import { cn } from "@/lib/utils";

const steps = [
  { id: 1, icon: User, title: "Perfil" },
  { id: 2, icon: MapPin, title: "Endereço" },
  { id: 3, icon: CreditCard, title: "Pagamento" },
  { id: 4, icon: CheckCircle, title: "Concluído" },
];
